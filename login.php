...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Login || Kamukunji  Shop</title>
  ...
  <body>
    ...
    <form method="POST" action="verify.php" style="margin-top:30px;" class="form-signin">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="johndoe@gmail.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
